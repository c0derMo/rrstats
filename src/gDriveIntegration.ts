...
const _newGDriveObjectToMatchlist = (obj, competition="Unknown", debugLog=false, columnDefinitions=[3, 4, 5, 7, 6, [8, 10, 12]]) => {
    let matches = [];
...
export default _newGDriveObjectToMatchlist;
