...
if (
    props.itemLabels != null &&
    props.itemLabels.length !== props.max - props.min + 1
) {
    console.warn(
        `[RangeSelector] itemLabels length has incorrect amount of items. Expected: ${props.max - props.min + 1}, got: ${props.itemLabels.length}.`,
    );
}
