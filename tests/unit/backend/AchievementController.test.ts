...
describe("AchievementController", () => {
    ...
    test("updateAchievements", async () => {
        ...
        const automaticAchievementMocks: MockInstance<
            (m: Match, p1: Achievement, p2: Achievement) => Promise<void>
        >[] = [];
    ...
    test("recalculateAllAchievements", async () => {
        ...
        saveMock.mockResolvedValue(new Achievement());
        const automaticAchievementMocks: MockInstance<
            (m: Match[], ach: Record<string, Achievement>) => Promise<void>
        >[] = [];
        for (const achievement of AchievementController.automaticAchievements) {
    ...
    test("getAchievementStatistics", async () => {
        ...
        expect
            .soft(stats["Roulette Player"])
            .toEqual([
                0.029535864978902954, 0.05063291139240506, 0.11392405063291139,
                0.2616033755274262, 0.5147679324894515, 0.6962025316455697, 1,
            ]);
        expect
            .soft(stats["Spin the Wheel"])
            .toEqual([
                0.012658227848101266, 0.029535864978902954, 0.08438818565400844,
                0.20675105485232068, 0.350210970464135, 0.5358649789029536,
                0.8607594936708861,
            ]);
        expect
            .soft(stats["Getting Mileage"])
            .toEqual([
                0.03375527426160337, 0.10970464135021098, 0.16877637130801687,
                0.2869198312236287, 0.5147679324894515,
            ]);
        expect
            .soft(stats["Open Season"])
            .toEqual([
                0, 0.02109704641350211, 0.046413502109704644,
                0.16033755274261605, 0.5147679324894515,
            ]);
        expect
            .soft(stats["Globetrotter"])
            .toEqual([
                0.012658227848101266, 0.0759493670886076, 0.21940928270042195,
            ]);
        expect
            .soft(stats["Returning Rival"])
            .toEqual([
                0.008438818565400843, 0.046413502109704644, 0.11392405063291139,
                0.31223628691983124, 0.6455696202531646,
            ]);
        expect
            .soft(stats["Against the World"])
            .toEqual([
                0.04219409282700422, 0.0759493670886076, 0.14767932489451477,
                0.29957805907172996, 0.6118143459915611,
            ]);

        expect
            .soft(stats["Points for You"])
            .toEqual([
                0.016877637130801686, 0.09282700421940929, 0.18565400843881857,
                0.31645569620253167, 0.4810126582278481, 0.5864978902953587,
                0.8016877637130801,
            ]);
        expect.soft(stats["Cutting Edge"]).toEqual([0.759493670886076]);
        expect
            .soft(stats["Dressed for the Occasion"])
            .toEqual([0.5738396624472574]);
        ...
        expect
            .soft(stats["History Repeats Itself"])
            .toEqual([
                0.02531645569620253, 0.14767932489451477, 0.32489451476793246,
            ]);
        expect
            .soft(stats["Globally Innovative"])
            .toEqual([
                0.02109704641350211, 0.06751054852320675, 0.25316455696202533,
            ]);
        expect
            .soft(stats["World of Assassination"])
            .toEqual([
                0.008438818565400843, 0.04219409282700422, 0.1308016877637131,
            ]);
        ...
        expect
            .soft(stats["Overtime"])
            .toEqual([
                0.02531645569620253, 0.046413502109704644, 0.10548523206751055,
                0.23628691983122363, 0.41350210970464135,
            ]);
        ...
        expect
            .soft(stats["The Roulette Rival"])
            .toEqual([
                0.016877637130801686, 0.08860759493670886, 0.25316455696202533,
            ]);
        expect
            .soft(stats["Spin to Win"])
            .toEqual([
        ...
        expect
            ...
            .toEqual([
                0.05485232067510549, 0.10126582278481013, 0.21940928270042195,
            ]);
        expect
            .soft(stats["On a Roll"])
            .toEqual([
                0.03375527426160337, 0.09282700421940929, 0.3628691983122363,
            ]);
        expect
            .soft(stats["On a Streak"])
            .toEqual([
                0.03375527426160337, 0.17721518987341772, 0.5316455696202531,
            ]);
        expect
            .soft(stats["On a Mission"])
            .toEqual([
                0.05063291139240506, 0.22362869198312235, 0.5738396624472574,
            ]);
        ...
        expect
            .soft(stats["Perfecting the Craft"])
            .toEqual([0.38396624472573837]);
        ...
        expect
            .soft(stats["Fall into Place"])
            .toEqual([
                0.11392405063291139, 0.13924050632911392, 0.25316455696202533,
                0.45147679324894513, 0.7974683544303798,
            ]);
        ...
        expect
            .soft(stats["Challenger & Defender"])
            .toEqual([0.02109704641350211]);
        ...
        expect
            .soft(stats["Beaten the Best"])
            .toEqual([
                0.008438818565400843, 0.08438818565400844, 0.22362869198312235,
            ]);
        expect
            .soft(stats["Rarified Air"])
            .toEqual([
                0.008438818565400843, 0.06751054852320675, 0.15611814345991562,
            ]);
