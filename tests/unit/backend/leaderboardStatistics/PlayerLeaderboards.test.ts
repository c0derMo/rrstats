...
describe("Player Leaderboards", () => {
    ...
    test("Matches casted", async () => {
        const players =
            await LeaderboardController.getEntries("Matches casted");
    ...
    test("Matches played", async () => {
        const players =
            await LeaderboardController.getEntries("Matches played");
    ...
    test("Reverse sweeps", async () => {
        const players =
            await LeaderboardController.getEntries("Reverse sweeps");
